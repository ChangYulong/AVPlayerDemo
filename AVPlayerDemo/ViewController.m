...
//  AVPlayerDemo
//
//  Created by shanghaikedu on 16/1/13.
...
- (void)setupUI{
    ...
    playerLayer.frame = CGRectMake(0, 0, self.container.frame.size.width, self.container.frame.size.height);
    //playerLayer.frame = self.container.layer.frame;
 ...
 *  @return AVPlayerItem 对象
 */
- (AVPlayerItem *)getPlayItem:(int)videoIndex{
    NSString * urlStr = [[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"%i",videoIndex] ofType:@"mp4"];
